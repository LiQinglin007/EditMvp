...
public class AlertEditDialog {
	...
	public AlertEditDialog builder() {
		...
		View view = LayoutInflater.from(context).inflate(
				R.layout.view_edit_alertdialog, null);

		// 获取自定义Dialog布局中的控件
		lLayout_bg = (LinearLayout) view.findViewById(R.id.lLayout_bg);
		txt_title = (TextView) view.findViewById(R.id.txt_title);
		txt_title.setVisibility(View.GONE);
		txt_msg = (EditText) view.findViewById(R.id.edit_msg);
	...
	public AlertEditDialog setMsg(String msg) {
		...
		if ("".equals(msg)) {
			...
			txt_msg.setHint(msg);
			txt_msg.setCursorVisible ( false );
		}
		return this;
	}
	...
	public AlertEditDialog setPositiveButton(String text,
		...
		btn_pos.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				mDialogCallBack.DialogCallBack(txt_msg.getText().toString());
				dialog.dismiss();
			}
		});
		return this;
...
//				listener.onClick(v);
	...
	public interface DialogCallBack{
		void DialogCallBack(String index);
	}
}
